...
#define BATADV_SOURCE_VERSION "2024.4 ahmedo_collmode"
#endif

/* B.A.T.M.A.N. parameters */

//something about collision, this is for first value of last packet time in 
//bat_priv
#define KTIME_INVALID  ((ktime_t)-1)

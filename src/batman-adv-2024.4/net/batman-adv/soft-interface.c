...
//collision counter'ini sifirlamak icin ekledim.
void batadv_reset_counter(struct batadv_priv *bat_priv, size_t idx)
{
    u64 *counters;
    int cpu;
...
static int batadv_softif_init_late(struct net_device *dev)
{
	...
	atomic_set(&bat_priv->collision_mode, 0);

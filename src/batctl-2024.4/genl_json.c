...
static void nljson_print_int64(struct nlattr *attrs[], int idx)
{
	printf("%" PRId64, nla_get_s64(attrs[idx]));
}
...
static const struct nla_policy_json batadv_genl_json[NUM_BATADV_ATTR] = {
	/*[BATADV_ATTR_SOMETHING] = {
		.name = "something",
		.cb = nljson_print_uint8,
	},*/
	[BATADV_ATTR_COLLMODE_THRESHOLD] = {
		.name = "collmode_threshold",
		.cb = nljson_print_int64,
	},
	...
	[BATADV_ATTR_COLLMODE_LAST_DIFFERENCE] = {
		.name = "collmode_last_difference",
		.cb = nljson_print_int64,
	},

	[BATADV_ATTR_COLLMODE_MIN_DIFF] = {
		.name = "collmode_min_difference",
		.cb = nljson_print_int64,
	},
	[BATADV_ATTR_COLLMODE_MAX_DIFF] = {
		.name = "collmode_max_difference",
		.cb = nljson_print_int64,
	},
	[BATADV_ATTR_COLLMODE_RESET_STAT] = {
		.name = "collmode_reset_stats",
		.cb = nljson_print_uint8,
	},

	[BATADV_ATTR_HOPMODE_COMMAND] = {
		.name = "hopmode_command",
		.cb = nljson_print_uint8,
	},
	[BATADV_ATTR_HOPMODE_PENALTY] = {
		.name = "hopmode_penalty",
